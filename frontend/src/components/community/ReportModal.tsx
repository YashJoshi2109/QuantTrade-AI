        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-white/[0.06]">
              ...
              <button
                onClick={handleClose}
                className="p-1.5 rounded-lg text-slate-500 hover:text-slate-300 hover:bg-white/[0.05] transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
              ...
              <>
                ...
                <div className="p-5 space-y-4">
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full bg-[#161b22] border border-white/[0.08] rounded-xl px-4 py-3 text-sm text-slate-100 placeholder-slate-500 resize-none focus:outline-none focus:border-blue-500/40"
                  />
                </div>
                ...
                <div className="flex items-center justify-end gap-3 px-5 py-4 border-t border-white/[0.06]">
                  <button
                    onClick={handleClose}
                    className="px-4 py-2.5 text-sm text-slate-400 hover:text-slate-200 transition-colors min-h-[44px]"
                  >
                    Cancel
                  </button>
                  <button
