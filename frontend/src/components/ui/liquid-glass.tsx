...
export const GlassButton: React.FC<{
  ...
  <GlassEffect
    className={`rounded-2xl px-6 py-3 hover:px-7 hover:py-3.5 hover:rounded-3xl overflow-hidden ${
  ...
  >
    <button
      onClick={onClick}
      disabled={disabled}
      className="transition-all duration-700 hover:scale-95 w-full"
      style={{
        transitionTimingFunction: "cubic-bezier(0.175, 0.885, 0.32, 2.2)",
      }}
    >
...
// SVG Filter Component (must be rendered once in the page)
