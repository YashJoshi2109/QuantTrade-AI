...
export default function GlobalMonitorRightColumn() {
  return (
    <div className="flex h-full flex-col gap-4">
      ...
      <div className="rounded-2xl border border-slate-800/70 bg-slate-950/90 overflow-hidden">
        <PredictionMarketsPanel />
      </div>

      {/* Polymarket heatmap – open source prediction markets by odds/volume */}
      <div className="rounded-2xl border border-slate-800/70 bg-slate-950/95 overflow-hidden flex-1">
        <PolymarketHeatmap />
      </div>
    </div>
  )
