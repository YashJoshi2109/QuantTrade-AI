    ...
    <AppLayout>
      <div className="min-h-[70vh] flex items-center justify-center p-6">
        <div className="hud-panel max-w-md w-full p-8 text-center">
          <ArrowLeftCircle className="w-10 h-10 text-fg-primary mx-auto mb-4" />
          ...
          <div className="flex items-center justify-center gap-3 text-sm">
            <Link
              href="/"
              className="px-4 py-2 rounded-lg bg-surface-raised hover:bg-surface-hover text-slate-100 transition-colors"
            >
              Back to dashboard
            </Link>
            <Link
