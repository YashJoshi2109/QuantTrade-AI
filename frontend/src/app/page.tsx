...
function ExchangeSessionsPopover({ continent }: { continent: Continent }) {
  ...
  return (
    <div className="relative group/sessions">
      ...
      <div className="pointer-events-none absolute right-0 top-full mt-2 w-[min(100vw-2rem,22rem)] max-h-[min(70vh,420px)] overflow-y-auto rounded-2xl border border-cyan-500/20 bg-[#0a101f]/95 backdrop-blur-xl px-3 py-3 text-[10px] opacity-0 translate-y-1 shadow-2xl shadow-black/40 z-[60] transition-all group-hover/sessions:opacity-100 group-hover/sessions:translate-y-0 group-hover/sessions:pointer-events-auto">
